...
export default function CreateToleePage() {
  ...
  const handleCreate = async () => {
    ...
    if (result.success && result.tolee) {
      router.push(`/t/${result.tolee.slug}`);
    } else {
          ...
          <div className="space-y-4">
            ...
            {isAdvancedOpen && (
              <div className="space-y-4 pt-2 border-t border-gray-100 dark:border-gray-800">
                ...
                {/* Location */}
                <div>
                  <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Location (Optional)</label>
                  <Input
                    placeholder="e.g. Mumbai, Dubai"
                    value={location}
                    onChange={(e) => setLocation(e.target.value)}
                    className="h-12 rounded-lg bg-transparent border-gray-300 dark:border-gray-700 text-sm px-4"
                  />
                </div>
        ...
        <div className="bg-white dark:bg-[#121212] rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 flex-1 max-w-4xl mx-auto w-full flex flex-col overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto bg-white dark:bg-[#121212]">
            ...
            <div className="relative w-full h-[350px] bg-gray-200 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-800 rounded-b-xl flex items-center justify-center">
              <img src={coverPreview || "https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=1200&q=80"} alt="Cover" className={`w-full h-full object-cover rounded-b-xl ${coverPreview ? '' : 'opacity-60 grayscale-[30%]'}`} />
              {!coverPreview && (
                <div className="absolute inset-0 flex flex-col items-center justify-center text-gray-500 dark:text-gray-400 font-medium">
            ...
            <div className="px-8 pt-6 pb-4 relative">
              ...
              <h1 className={`text-3xl font-extrabold text-gray-900 dark:text-white mb-2 ${avatarPreview ? 'mt-8' : ''}`}>
